...
async function getData(url = "", keyword = "") {
  ...
  const response = await fetch(backendURL + "/api/customer" + queryParams, {
    headers: {
...
form_customers.onsubmit = async (e) => {
  ...
  document.querySelector(
    "#form_customers button[type = 'submit']"
  ).disabled = true;
  document.querySelector(
    "#form_customers button[type = 'submit']"
  ).innerHTML = `<div class="col-sm-12 d-flex justify-content-center align-items-center">
  ...
  if (for_update_id == "") {
    ...
    response = await fetch(backendURL + "/api/customer", {
      method: "POST",
      headers: {
        Accept: "application/json",
        Authorization: "Bearer " + localStorage.getItem("token"),
  ...
  // For Update
    ...
    response = await fetch(backendURL + "/api/customer/" + for_update_id, {
...
const deleteAction = async (e) => {
  ...
  confirmDeleteBtn.addEventListener("click", async () => {
    ...
    const response = await fetch(backendURL + "/api/customer/" + id, {
      method: "DELETE",
      headers: {
        Accept: "application/json",
        Authorization: "Bearer " + localStorage.getItem("token"),
